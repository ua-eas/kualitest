...
public class RandomSelectDocumentLookupHandler extends SelectEditDocumentLookupHandler  {
    private static final Logger LOG = Logger.getLogger(RandomSelectDocumentLookupHandler.class);

    @Override
    public String getDescription() {
        return "This handler will randomly select a document from a document lookup list";
    }
